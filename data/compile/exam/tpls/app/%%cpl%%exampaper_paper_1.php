...
<div class="container-fluid" id="questioncontent">
 ...
 $qnid++; ?>
		                <?php $tid++; ?>
						<a id="sign_<?php echo $question['questionid']; ?>" href="#question_<?php echo $question['questionid']; ?>" class="btn btn-default<?php if($this->tpl_var['sessionvars']['examsessionsign'][$question['questionid']]){ ?> btn-danger<?php } ?>"><?php echo $tid; ?></a>
						<?php } ?>
						<?php $qrid = 0;
 ...
 $did++; ?>
		                <a id="sign_<?php echo $data['questionid']; ?>" href="#question_<?php echo $data['questionid']; ?>" class="btn btn-default<?php if($this->tpl_var['sessionvars']['examsessionsign'][$data['questionid']]){ ?> btn-danger<?php } ?>"><?php echo $tid; ?>-<?php echo $did; ?></a>
            			<?php } ?>
            			<?php } ?>
					</dd>
					<?php } ?>
