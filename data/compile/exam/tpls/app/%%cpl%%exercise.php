...
<div class="container-fluid">
 ...
 $qid++; ?>
	                        <li class="text_in">
	                        	<?php echo $quest['questype']; ?>（共<?php echo $this->tpl_var['numbers'][$quest['questid']]; ?>题），选 <input id="question_<?php echo $quest; ?>" type="text" class="form-control" name="args[number][<?php echo $quest; ?>]" style="width:60px;" onChange="javascript:check_num(this);" onBlur="" rel="<?php echo $this->tpl_var['numbers'][$quest]; ?>"/> 题
