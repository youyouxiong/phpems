		...
		<div style="width:95%;margin:auto;margin-top:0.6rem;background-color:#FFFFFF;overflow:hidden;padding:1.2rem;">
			<a class="ajax" href="index.php?content-phone-category&catid={x2;v:cat['catid']}" data-target="contentcategory" data-page="contentcategory">{x2;v:cat['catname']} <span class="glyphicon glyphicon-chevron-right pull-right"></span></a>
		</div>
		{x2;endtree}
		{x2;endif}