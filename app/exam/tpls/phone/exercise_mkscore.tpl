		...
		<div class="container-fluid" id="datacontent">
			<div class="row-fluid">
				<form id="form1" name="form1" class="col-xs-12" action="index.php?exam-phone-exercise-makescore">
					{x2;eval: v:oid = 0}
		            ...
		            <div style="clear:both;overflow:hidden;background:#FFFFFF;margin-top:0.5rem;padding:1rem;">
		                ...
		                <div class="choice" style="line-height:2.5rem;">
	                  		<input type="text" class="col-xs-12" name="score[{x2;v:question['questionid']}]" value="" maxvalue="1">
	                  		<span class="text-error">【请根据参考答案给出分值】提示：本题共1分，可输入0.5的倍数。</span>
	                  	</div>
					</div>
					{x2;endtree}
	                ...
	                <div style="clear:both;overflow:hidden;background:#FFFFFF;margin-top:0.5rem;padding:1rem;">
	                	...
	                	<div style="padding:0rem 1.5rem;margin-top:1rem;">
			                ...
			                <div class="choice" style="line-height:2.5rem;">
		                  		<input type="text" class="col-xs-12" name="score[{x2;v:data['questionid']}]" value="" maxvalue="1">
		                  		<span class="text-error">【请根据参考答案给出分值】提示：本题共1分，可输入0.5的倍数。</span>
		                  	</div>
						</div>
						{x2;endtree}
