			...
			<div class="selector">
				...
				<textarea class="jckeditors" etype="simple" id="editor{x2;$dataid}" name="question[{x2;$dataid}]" rel="{x2;$question['questionid']}">{x2;realhtml:$sessionvars['examsessionuseranswer'][$dataid]}</textarea>
			</div>
			{x2;endif}
            ...
            <div class="paperexamcontent_{x2;$vquestion['questionid']} form-horizontal" style="padding:0rem 1.5rem;">
				...
				<div class="selector questionanswerbox">
					...
					<textarea class="jckeditors" etype="simple" id="editor{x2;$dataid}" name="question[{x2;$dataid}]" rel="{x2;$vquestion['questionid']}">{x2;realhtml:$sessionvars['examsessionuseranswer'][$dataid]}</textarea>
				</div>
				{x2;endif}
				<div class="choice" style="margin-top:20px;overflow:hidden;">
