...
class action extends app
{
	...
	private function del()
	{
		...
		$this->G->msg(array('url'=>'index.php?exam-master-asks&page='.$page));
	}
	...
	private function delanswer()
	{
		...
		$this->G->msg(array('url'=>'index.php?exam-master-asks-detail&askid='.$answer['answeraskid'].'&page='.$page));
	}
	...
	private function rely()
	{
		...
		$this->G->msg(array('url'=>'index.php?exam-master-asks-detail&askid='.$id.'&page='.$page));
	}
